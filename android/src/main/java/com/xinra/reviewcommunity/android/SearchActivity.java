...
public class SearchActivity extends AbstractActivity {
  ...
  // Current behaviour: if you use the search widget in the action bar you get here. If you then
  // change the query using the search widget embedded in this activity, you stay in this activity
  ...
  // using the action bar search. This could be fixed by omitting onNewIntent() and using a
  ...
  private void performSearch(String query) {
    ...
    getApi().search(query).subscribe(resultsView::setContent, this::handleError);
  }
}
